...
export default function ProjectCard ({ id, nom, description, screenshots, url, odd } : Props) {
  ...
  return (
    <div 
      className={`project-card flex flex-col-reverse ${odd? 'md:flex-row' : 'md:flex-row-reverse'} gap-2 md:gap-8 justify-center text-lg md:p-8 md:bg-zinc-500/20 rounded-lg md:shadow-lg md:h-[38vw]`}
    ...
    >
      <div className="project-info w-full md:w-1/3 self-center">
        ...
        <div className="project-links flex flex-wrap justify-center md:justify-start gap-x-4 gap-y-2">
